  ...
  return (
    <section id="services" className="services section light-background">
      ...
      <div className="container">
        ...
        {/* Inline Content Display (desktop only) */}
        {!isMobile && currentTab && (
          <div className="row" data-aos="fade-up" data-aos-delay={200}>
            <div className="col-12">
              <div className="bg-white rounded-4 p-5 shadow-sm border">
        ...
        {isMobile && currentTab && (
          <div className="modal-backdrop-custom" onClick={() => setActiveTab(null)}>
            <div 
            ...
            >
              <div className="d-flex justify-content-between align-items-center mb-3">
                <h5 className="fw-bold">{currentTab.title}</h5>
                <button className="btn-close" onClick={() => setActiveTab(null)} />
              </div>
              <p className="text-muted">{currentTab.details}</p>
              <img 
                src={currentTab.image} 
                alt={currentTab.title} 
                className="img-fluid rounded-3 shadow" 
